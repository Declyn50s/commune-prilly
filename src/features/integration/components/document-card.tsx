...
import type { IntegrationDocument } from "@/features/integration/types";

export function IntegrationDocumentCard({ item }: { item: IntegrationDocument }) {
    ...
    return (
      <div className="block h-full">
        <div className="surface h-full p-5">
          ...
          <p className="mt-4 inline-flex rounded-full bg-prilly-yellow/20 px-3 py-1.5 text-sm font-medium text-prilly-coal">
